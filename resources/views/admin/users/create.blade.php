                ...
                <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" 
                            class="w-full px-4 py-2 bg-gray-700/50 border border-purple-500/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-purple-500/50 focus:border-purple-500"
